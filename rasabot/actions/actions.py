...
class ActionHandleRegistrationNumber(Action):
    ...
    def run(self, dispatcher: CollectingDispatcher,
        ...
        response = requests.post("http://127.0.0.1:8800/api/get_child_nutrition_recomendations/", json={"registration_number": registration_number})
...
class ActionHandleRegistrationNumberForVisit(Action):
    ...
    def run(self, dispatcher: CollectingDispatcher,
        ...
        if registration_number:
            response = requests.post('http://127.0.0.1:8800/api/get_next_visit/', json={'registration_number': registration_number})
